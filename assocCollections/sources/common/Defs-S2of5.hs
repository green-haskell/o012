...
baseNElems = 40000
    ...
    {-
        ...
        addToNElems - number of elements in a associative collection, to add to

        addFromNElems - number of elements to add to a associative collection for the add benchmark operation
...
addOpDesc   = "add_" ++ show addFromNElems ++ "_elements_to_" ++ show addToNElems
    ...
    {-
        ...
        addAllFromNElems - number of elements in a associative collection, to add to another associative collection, for the addAll operation
...
removeOpDesc = "remove_" ++ show removeNRepeats ++ "_times_from_" ++ show removeFromNElems
    ...
    {-
        ...
        removeAllNElems - number of elements to remove from a associative collection, for the removeAll operation
