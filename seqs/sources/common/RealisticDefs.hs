...
addToNElems :: Int
--addToNElems = baseNElems -- >3hrs for BinaryRandList (server)
--addToNElems = 50000 -- >3hrs for BinaryRandList (server)

--addToNElems = 25000 -- Just above 3hrs on the Lab; Maybe less on the Server?.
                      -- I think, just under 3hrs at home;
                      -- >5hrs for BinaryRandList (server)
--addToNElems = 12500 -- >4hrs for BinaryRandList (server)
--addToNElems = 6250  -- >3hrs for BinaryRandList (server)
addToNElems = 3125

addFromNElems :: Int
--addFromNElems = 10000 -- >3hrs for BinaryRandList (server)
addFromNElems = 50000
...
--containsAllSearchInNElems = baseNElems -- >4h for BankersQueue (server)
...
--containsAllNRepeats = 5000 -- Default   >3hrs for BraunSeq (server)
--containsAllNRepeats = 2500 -- > 12h for FingerSeq (server)

--containsAllNRepeats = 400 -- about 1 Hour (home)
--containsAllNRepeats = 800 -- 2:35 hh:mm (home)
--containsAllNRepeats = 1250 -- 4 hours (home)
