        ...
        simplifiedFilesContentsAsLines = map (
            ...
            DTL.replace ( DTL.pack (
                case feature of
                    ...
                    --"energy" -> "EnergyConsumption/Sequence/Data.Edison.Seq."
                    "packageEnergy" -> "PackageEnergyConsumption/Sequence/Data.Edison.Seq."
                    "dramEnergy" -> "DRAMEnergyConsumption/Sequence/Data.Edison.Seq."
